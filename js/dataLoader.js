...
import { layersById, addRouteToList } from './routes.js';
...
export function loadData() {
    fetch('data.json')
        ...
        .then(data => {
            ...
            data.forEach((meta, idx) => {
                ...
                gpx.on('loaded', function (e) {
                    ...
                    allBounds = boundsAccumulator.reduce((acc, curr) => acc.extend(curr));
                    ...
                    const popupHtml = `
                        <div>
                            ...
                            <div style="font-size:12px;"><b>Duración total:</b> ${formatDuracion(durTotalS)}</div>
        ...
        .catch(err => {
            ...
            alert('No se pudo cargar data.json. Asegúrate de servir los archivos vía HTTP.');
        });
}
